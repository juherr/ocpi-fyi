...
// - Each root aggregate is generated in the public cache without changing tracked source files
...
function main() {
  ...
  for (const version of versions) {
    const srcRootSpec = path.join(AGGREGATE_CACHE_DIR, `ocpi-${version}`, "openapi.yaml");
    execFileSync(
      process.execPath,
      [path.join("tools", "generate-root-openapi.js"), version, "--output", srcRootSpec],
